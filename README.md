...
```bash
git clone https://github.com/YOUR_USERNAME/Personal-Knowledge-Agent.git
...
Endpoint формируется автоматически на основе твоего домена: `https://YOUR_DOMAIN/sse`
...
git clone git@github.com:YOUR_USERNAME/Personal-Knowledge-Agent.git app
cd app
python3 -m venv venv
...
```
https://YOUR_DOMAIN/sse?token=ВАШ_СЕКРЕТНЫЙ_ТОКЕН
```
